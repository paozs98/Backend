...
public class ProfesorServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      try {
        ProfesorModel profesores = profesor.getProfesorPorCedula(request.getParameter("cedula"));
        JSONObject jsonResponse = new JSONObject();
        if(profesores == null){
          jsonResponse.put("profesor", "null");
        } else {
          jsonResponse.put("nombre", profesores.getNombre());
          jsonResponse.put("email", profesores.getEmail());
          jsonResponse.put("telefono", profesores.getTelefono());
        }
